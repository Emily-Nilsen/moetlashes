  ...
  return (
    <div className="bg-rose-50">
      <header className="relative pb-36 bg-blue-gray-800">
        ...
        <Popover as="div" className="relative z-10">
          ...
          >
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full lg:w-auto">
                ...
                <div className="flex items-center -mr-2 lg:hidden">
                  <Popover.Button className="inline-flex items-center justify-center p-2 text-white bg-opacity-0 rounded-md bg-blue-gray-900 hover:bg-opacity-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-6">
              <a
                href="#"
                className="px-6 py-2 text-base font-medium text-white bg-blue-500 border border-transparent rounded-md shadow-md hover:bg-blue-600"
              >
                Login
              </a>
            </div>
            ...
            >
              <div className="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="flex items-center justify-between px-5 pt-4">
                  ...
                  <div className="-mr-2">
                    <Popover.Button className="inline-flex items-center justify-center p-2 bg-white rounded-md text-blue-gray-400 hover:bg-blue-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
                ...
                <div className="pt-5 pb-6">
                  <div className="px-2 space-y-1">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="block px-3 py-2 text-base font-medium rounded-md text-blue-gray-900 hover:bg-blue-gray-50"
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <div className="px-5 mt-6">
                    <a
                      href="#"
                      className="block w-full px-4 py-2 font-medium text-center text-white bg-blue-500 border border-transparent rounded-md shadow hover:bg-blue-600"
                    >
                      Login
                    </a>
                  </div>
        ...
        <div className="relative max-w-md px-4 pb-32 mx-auto mt-24 sm:max-w-3xl sm:px-6 md:mt-32 lg:max-w-7xl lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">
            Support
          </h1>
          <p className="max-w-3xl mt-6 text-xl text-blue-gray-300">
      ...
      <main>
        ...
        <section className="relative bg-rose-50" aria-labelledby="join-heading">
          <div
            ...
            aria-hidden="true"
          />
          <div className="mx-auto bg-blue-600 max-w-7xl lg:bg-transparent lg:px-8">
            <div className="lg:grid lg:grid-cols-12">
              ...
              <div className="relative bg-zinc-800 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md px-4 py-12 mx-auto space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  <a
                    className="block w-full px-5 py-3 text-base font-medium text-center text-blue-700 bg-white border border-transparent rounded-md shadow-md hover:bg-blue-gray-50 sm:inline-block sm:w-auto"
                    href="#"
                  >
