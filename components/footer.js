...
export default function Footer() {
  return (
    <footer className="bg-rose-50" aria-labelledby="footer-heading">
      ...
      <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <img className="h-10" src="/moet-rose-400.svg" alt="Company name" />
        ...
        <div className="pt-8 mt-12 border-t border-rose-200">
          <p className="text-base text-rose-300 xl:text-center">
