          ...
          <div className="grid w-full h-full grid-cols-1 gap-0 sm:gap-10 sm:grid-cols-2">
            <div className="relative flex items-center w-full h-full col-span-1 px-0">
              <div className="relative flex items-center justify-center w-full h-1/2">
                <Image
                  src="https://res.cloudinary.com/dt3k2apqd/image/upload/v1654529335/Mo%C3%ABt%20Lashes/SVGs/bed_sfe2th.svg"
                  alt="Try sleeping on your back to protect lashes"
                  unoptimized={true}
                  width="100%"
                  height="100%"
                  layout="intrinsic"
                ...
                >
                  <CheckIcon
                    className="w-20 h-20 -mt-8 text-lime-500"
                    aria-hidden="true"
                  />
                </motion.div>
              </div>
            ...
            <div className="flex flex-col justify-center h-full col-span-1 px-6 text-center sm:text-left">
              ...
              >
                {t('lashes:step_2_text_start')}{' '}
                <span className="font-bold tracking-tight text-rose-400">
                  {t('lashes:step_2_text_bold')}
                </span>{' '}
                {t('lashes:step_2_text_end')}
              </motion.p>
            </div>
          </div>
        </div>
