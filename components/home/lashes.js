...
export default function Lashes() {
  return (
    <div className="bg-white">
      ...
      <div className="relative pb-16 -mt-16 overflow-hidden md:-mt-10">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-6 prose prose-lg text-zinc-500 prose-rose">
            ...
            <p>Nagaraku is a Japanese word meaning,</p>
            <blockquote>
              <p>immortal beauty, full of happiness.</p>
            </blockquote>
            <p>
            ...
            <figure>
              <img
                ...
                src="/static/home/moetlashes-img-3.webp"
                alt=""
                width={1310}
                height={873}
              />
            ...
            <figure>
              <img
                className="w-full rounded-lg"
                src="/static/home/moetlashes-img-6.webp"
                alt=""
                width={1310}
                height={873}
              />
